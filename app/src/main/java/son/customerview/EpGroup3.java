 ...
 * Created on 2019/3/9.
 */
public class EpGroup3 extends LinearLayout {
    public EpGroup3(Context context) {
        super(context);
    }

    public EpGroup3(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public EpGroup3(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
