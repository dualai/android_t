 ...
 * Created on 2019/3/9.
 */
public class EpGroup1 extends LinearLayout {
    public EpGroup1(Context context) {
        super(context);
    }

    public EpGroup1(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public EpGroup1(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
